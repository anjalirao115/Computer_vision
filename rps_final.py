...
First way: the user selects his choice from rock, paper or scissors by giving his/her input on terminal
Second way: the user records his/her choice using hand gestures shown in webcam window.
One can comment/uncomment one line in play() function to run the code in either way.
'''
...
def play():
    ...
    while True:
        ...
        #u_choice = game.get_user_choice()              # uncomment this to play game without camera
        u_choice = game.get_camera_choice()             # comment this to play game without camera
